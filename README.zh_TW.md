...
- **多語言支援** — 提供 英語、簡體中文、繁體中文、日語、韓語、俄語 六種介面語言。
...
>
> **Firefox 使用者可直接在 [Firefox Add-ons](https://addons.mozilla.org/firefox/addon/pixtab/) 官方商店安裝本擴充功能。**

> **注意**：本擴充功能暫未上架 Chrome Web Store，Chrome 使用者請按以下步驟手動安裝。
...
1. 克隆或下載本倉庫。
2. 使用 Firefox 140 或更高版本，在瀏覽器中打開 `about:debugging#/runtime/this-firefox`。
...
如果您覺得 PixTab 幫到了您，您可以對我進行支持和捐助。您的每一份鼓勵都是我繼續前行的動力，不勝感激！(╹▽╹)

- [愛發電](https://afdian.com/a/cloud09)
