...
- **다국어 지원** — 영어, 간체중문(简体中文), 번체중문(繁體中文), 일본어, 한국어, 러시아어를 지원합니다。
...
PixTab이 도움이 되셨다면, 후원해 주시면 정말 감사하겠습니다. 여러분의 따뜻한 응원이 제가 계속 개발할 수 있는 힘이 됩니다. 진심으로 감사드립니다! (╹▽╹)

- [Afdian (애발전)](https://afdian.com/a/cloud09)
